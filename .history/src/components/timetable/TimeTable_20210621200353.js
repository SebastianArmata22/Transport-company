    ...
    return (
        ...
        <div className="card-body">
            <div className={classes.timeTable}>
               ...
               {timeTable.map((item, index)=><TimeTableItem item={item} end={timeTableEnd[index]}  price={price} busStopStart={busStopsData.busStops[startingBusStop]} busStopEnd={busStopsData.busStops[endingBusStop]} date={date} setTickets={setTickets}/>)}
               </div>
