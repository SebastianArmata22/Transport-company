...
const TicketsPanel = ({tickets, user, setShowShopping,setUserData}) => {
    ...
    const discount=()=>{
        if(Math.round((parseFloat(tickets.price)-parseFloat(price))*10)/10!==user.points/10)
        console.log(parseFloat(tickets.price)-parseFloat(price), "1")
        console.log(user.points/10, "2")
