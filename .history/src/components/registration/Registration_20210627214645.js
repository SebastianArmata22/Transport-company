    ...
    const registrarion=(event)=>{
        ...
        if(user.password===user.repeatPassword){
            ...
            .then(async (userCredential) => {
              ...
              await usersCollection.doc(userData.uid).set({name: user.name, lastName: user.lastName, email: user.email, type: user.type, points: user.points}).then(() => {
                console.log("Document successfully written!");
                NotificationManager.success('Stworzono użytkownika')
