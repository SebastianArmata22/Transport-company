...
const JourneysItem = ({item, end,price, busStopStart, busStopEnd, date, setTickets, setShowShopping}) => {
    ...
    return (
        <div className={classes.item}>
            ...
            <div className={classes.buyTicket}>
                <button onClick={buyTickets}>Zmień godzinę</button>
            </div>
        </div>
    )
}

export default JourneysItem
